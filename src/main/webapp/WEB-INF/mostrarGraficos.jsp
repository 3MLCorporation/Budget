...
<div>
  ...
  <script>
    ...
    /* Gráfico de pizza*/
    ctx=document.getElementById("graficoPizza"),graficoPizza=new Chart(ctx,{type:"pie",data:{labels:["Valor livre","Valor gasto"/*,"Yellow","Green"*/],datasets:[{data:[50,50],backgroundColor:["#007bff","#dc3545"/*,"#ffc107","#28a745"*/]}]}});


    /*
    
    function valorLivre(){
      var valorParcial = parseFloat(${projeto.getValorParcial()}.value);
      var valorMaximo = parseFloat(${projeto.getValorTotal()}.value);
